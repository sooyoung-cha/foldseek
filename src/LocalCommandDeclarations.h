...
extern int scoremultimerfast(int argc, const char **argv, const Command& command);
extern int easymultimercluster(int argc, const char** argv, const Command &command);
extern int easymultimerclusterfast(int argc, const char** argv, const Command &command);
extern int multimercluster(int argc, const char** argv, const Command &command);
extern int multimercluster_fast(int argc, const char** argv, const Command &command);
...
extern int chainmultimerprefilter(int argc, const char **argv, const Command &command);
